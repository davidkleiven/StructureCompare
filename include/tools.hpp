...
namespace tools
{
  ...
  template<unsigned int N>
  void dot( const std::array< std::array<double,N>, N> &m1,  const std::array< std::array<double,N>, N> &m2, std::array< std::array<double,N>, N> &out )
  {
    for ( unsigned int i=0;i<N;i++ )
    {
  ...
  template<unsigned int N>
  void dot( const std::array< std::array<double,N>,N> &mat, const std::array<double,N> &vec, std::array<double,N> &out )
  {
    for ( unsigned int i=0;i<N;i++ )
    {
      out[i] = 0.0;
  ...
  inline double det3x3( const std::array< std::array<double,3>, 3> &mat )
  {
    double V = 0.0;
  ...
  inline void inv3x3( const std::array< std::array<double,3>, 3> &mat, std::array< std::array<double,3>, 3> &out )
  {
